  ...
  <section id="container">
	...
	<section id="main-content">
      <section class="wrapper">
        <h3 class="donor_R"><i class="fa fa-angle-right"></i>Donor Requests</h3>
		  <div class="tables_show_format">
              
			<?php        while (($row = $stmt->fetch_assoc()) != NULL) {                               ?>
	  
	 <table align="center" border="6px" style="width:1550px; line-height:100px; margin-left:130px; color:black; font-size:20px; background-color:white;">
