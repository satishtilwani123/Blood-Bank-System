  ...
  <section id="container">
	...
	<section id="main-content">
      <section class="wrapper">
        <h3 class="upload_request"><i class="fa fa-angle-right"></i>Upload Request</h3>
        ...
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-6">
			...
			<div class="info">
              	<h4 class="title" style="font-size:25px;">Enter your location:</h4>
				...
				<h4 class="title" style="font-size:25px;">Chose Blood Group:</h4>
