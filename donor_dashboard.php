          ...
          <li class="sub-menu">
   		...
   		<section id="main-content">
   			<section class="wrapper site-min-height">
   				<h3 class="donor_p"><i class="fa fa-angle-right"></i>Donor Portal</h3>
       						...
       						<div class="tab">
								...
								<table>
									...
									<tr class="colors_head" style="background-color:#4d4d4d; color:white;">
										<th colspan="2"  ><h1>Donor Information</h1></th>
									</tr>
									...
									<tr>
    									...
    									<td><?php   
    										echo " ";
    										while ($row = $stmt->fetch_assoc()) {	echo $row['email']."<br>";}    ?></td>
  									</tr>
									...
									<tr>
    									...
    									<td><?php   
    										echo " ";
    										while ($row = $s1->fetch_assoc()) {    echo $row['location']."<br>";}    ?></td>
  									</tr>
