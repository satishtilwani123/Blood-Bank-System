  ...
  <section id="container">
	...
	<section id="main-content">
      <section class="wrapper">
        <h3 class="donor_p"><i class="fa fa-angle-right"></i>Payment Receipt</h3>
        <div class="row">
          <div class="col-md-12">
                ...
                <div class="tables_show_format">
			     <?php        while (($row = $stmt->fetch_assoc()) != NULL) {                               ?>
					...
					<table align="center" border="30px" style="width:1550px; line-height:100px; color:black; font-size:20px; background-color:white">
						<tr class="colors_show_head">
							<th colspan="1"  ><h3 align="center" style="font-size:40px; color:white;">Payment Receipt </h3></th>
						</tr>
...
<?php           }             ?>
			...
			<div align="center" style="margin-top:20px;">
				 <a class="btn btn-primary" style="padding-top:15px; padding-bottom:15px; padding-left:20px; padding-right:20px;" href="pay.php">Payment</a>
			</div>
