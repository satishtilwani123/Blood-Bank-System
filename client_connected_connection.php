  ...
  <section id="container">
	...
	<section id="main-content">
      <section class="wrapper">
        <h3 class="donor_p"><i class="fa fa-angle-right"></i>Connected Connections</h3>
               <div class="tables_show_format">
			<?php        while (($row = $stmt->fetch_assoc()) != NULL) {        ?>

		  		<table border="6px" style="width:1550px; line-height:60px; margin-left:120px; color:black; font-size:20px; background-color:white;">	
					...
					<tr>
						<td><div align="center"><?php echo $row['username']; $n=$row['username']; ?></div></td>
						<td><div align="center"><?php echo $row['location']; ?></div></td>
						<td><div align="center"><?php echo $row['blood_group']; 
								 $p2=$_SESSION['id']; $p1=$row['rid_fk']; $a=$row['did_fk'];?></div></td>
 					<td> 
