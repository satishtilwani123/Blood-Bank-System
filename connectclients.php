  ...
  <section id="container">
	...
	<section id="main-content">
      <section class="wrapper">
        <h3 class="connect_withclients"><i class="fa fa-angle-right"></i>Connect with clients</h3>
        	<div class="tables_format">
              
			  	<?php        while (($row = $stmt->fetch_assoc()) != NULL) {   ?>

		  			<table  border="6px" style="width:1550px; line-height:100px; margin-left:120px; color:black; font-size:20px; background-color:white;">
							<tr class="colors_head">
