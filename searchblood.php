  ...
  <section id="container">
	...
	<section id="main-content">
      <section class="wrapper">
        <h3 class="donor_p"><i class="fa fa-angle-right"></i>Search Request</h3>
        <div class="row mt">
	...
	<form class="request" name="form1" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
		...
		<div class="info">
			 <h4 class="title" style="font-size:25px;">Please Select Area Where You Want to get Blood:</h4>
	...
	<div class="tables_show_format">
	  <?php
        ...
        <table border="4px" style="width:1550px; line-height:100px; margin-left:300px; color:black; font-size:20px; background-color:white;">
        
		<tr class="colors_show_head">
        	<th colspan="8"  ><h3 align="center" style="color: white;">Donors In Your Areas</h3></th>
        </tr>
		...
		<td> <div align="center"> <a href='dreqconf.php?con=<?php   echo $p1   ?> '<button type="submit" class="btn btn-primary" > Connect Donor</button></a></td>   
       	</tr> 
